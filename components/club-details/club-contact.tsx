// Club Contact section with contact info and social links
// Author: Ifunaya
...
export function ClubContact({ club }: ClubContactProps) {
  return (
    <Card>
      <CardHeader>
        ...
        {club.website && (
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground truncate">{club.website}</p>
            </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {club.socialMedia.discord && (
                <Button variant="outline" size="sm" asChild>
                  <a
                    href={`https://${club.socialMedia.discord}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <svg
